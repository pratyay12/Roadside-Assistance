...
public class AddTwoWheeler extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        reff = FirebaseDatabase.getInstance().getReference().child("TwoWheeler");
        ...
        mSubmit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                else if(mGarageNumber.getText().toString().length() >13)
                {
                    ...
                    Toast.makeText(AddTwoWheeler.this, "Data Inserted Succesfully", Toast.LENGTH_LONG).show();
                }
            }
        });
    }
